...
static NSTimeInterval kQrLineanimateDuration = 0.015;
...
- (void)initQrMenu {
    ...
    qrMenu = [[QRMenu alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - height, width, height)];
