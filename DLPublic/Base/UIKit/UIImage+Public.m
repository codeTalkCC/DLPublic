...
+ (UIImage *)dl_imageWithColor:(UIColor *)color {
    return [self dl_imageWithColor:color size:CGSizeMake(1, 1)];
}
...
- (UIImage *)dl_imageByTintColor:(UIColor *)color {
...
- (UIImage *)dl_imageByRoundCornerRadius:(CGFloat)radius {
    return [self dl_imageByRoundCornerRadius:radius borderWidth:0 borderColor:nil];
}

- (UIImage *)dl_imageByRoundCornerRadius:(CGFloat)radius
                             borderWidth:(CGFloat)borderWidth
                             borderColor:(UIColor *)borderColor {
    return [self dl_imageByRoundCornerRadius:radius
